...
* [dogecoinrpc — Convenience functions](apireference/dogecoinrpc.md)
* [dogecoinrpc.connection — Connect to Dogecoin server via JSON-RPC](apireference/dogecoinrpc.connection.md)
